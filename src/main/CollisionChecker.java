    ...
    public void checkTile(Entity entity) {
        ...
        switch (entity.direction) {
            case "up":
                ...
                tileNum1 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityLeftCol][(int) entityTopRow];
                tileNum2 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityRightCol][(int) entityTopRow];
            ...
            case "down":
                ...
                tileNum1 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityLeftCol][(int) entityBottomRow];
                tileNum2 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityRightCol][(int) entityBottomRow];
                if (gp.tileManager.tile[(int) tileNum1].collision == true
                        || gp.tileManager.tile[(int) tileNum2].collision == true) {
                    entity.collisionOn = true;
                }
            ...
            case "left":
                ...
                tileNum1 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityLeftCol][(int) entityTopRow];
                tileNum2 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityLeftCol][(int) entityBottomRow];
                if (gp.tileManager.tile[(int) tileNum1].collision == true
                        || gp.tileManager.tile[(int) tileNum2].collision == true) {
                    entity.collisionOn = true;
                }
            ...
            case "right":
                ...
                tileNum1 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityRightCol][(int) entityTopRow];
                tileNum2 = gp.tileManager.mapTileNum[gp.currentMap][(int) entityRightCol][(int) entityBottomRow];
                if (gp.tileManager.tile[(int) tileNum1].collision == true
                        || gp.tileManager.tile[(int) tileNum2].collision == true) {
                    entity.collisionOn = true;
