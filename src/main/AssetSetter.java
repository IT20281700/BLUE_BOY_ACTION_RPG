...
public class AssetSetter {
	...
	public void setInteractiveTile() {
		...
		// to chest 2
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 10, 35);
		i++;
		
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 10, 36);
		i++;
		
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 9, 36);
		i++;
		
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 9, 37);
		i++;
		
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 9, 38);
		i++;
